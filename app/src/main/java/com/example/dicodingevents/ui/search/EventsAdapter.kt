...
import com.example.dicodingevents.databinding.AllItemBinding

class EventsAdapter(private val onItemClick: (ListEventsItem) -> Unit) : ListAdapter<ListEventsItem, EventsAdapter.ViewHolder>(DIFF_CALLBACK) {
    class ViewHolder(private val binding: AllItemBinding) : RecyclerView.ViewHolder(binding.root) {
